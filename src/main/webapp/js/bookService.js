            ...
            success: function (result) {
                ...
                for (var i = 0; i < result.length; ++i) {
                    ...
                    switch (result[i].owner) {
                        case null:
                            button = "<button  class='btn-default' onclick='getBook(this)'>Взять книгу</button>";
                            break;
                        case currentUser:
                            button = "<button class='btn-default' onclick='returnBook(this)'>Отдать книгу</button>";
                            break;
                        default :
                    ...
                    "<td>" + button + "</td>" +
                    "<td><button class='btn-default' onclick='deleteBook(this)'>Удалить</button></td>" + +"</tr>";
                }
                str += "</table>";
                $('#booksTable').html(str);
